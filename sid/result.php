    ...
    <header>
      ...
      <div class="main-content-header">
        <form method="post" action="result.php">
          ...
          <table class="table2">
              <tr>
               <th>Suject</th><th>Insem Exam (Score) </th><th>CIA score</th><th>Semester Exam (Score)</th><th>Total</th><th>Max. Marks</th>
              </tr>
              <tr>
                  
              <th>Java</th>
                <th><?php echo $data2['u_hindi1']; ?></th>
                <th><?php echo $data2['c_hindi1']; ?></th>
                <th><?php echo $data2['u_hindi2']; ?></th>
                <th><?php echo $total1=$data2['u_hindi1']+$data2['c_hindi1']+$data2['u_hindi2']; ?> </th>
                <th>100</th>
              </tr>
              <tr>  
              <th>Python</th>
                <th><?php echo $data2['u_english1']; ?></th>
                <th><?php echo $data2['c_english1']; ?></th>
                <th><?php echo $data2['u_english2']; ?></th>
                <th><?php echo $total2=$data2['u_english1']+$data2['c_english1']+$data2['u_english2']; ?> </th>
                <th>100</th>
              </tr>
              <tr>
              <th>DBMS</th>
                  <th><?php echo $data2['u_math1']; ?></th>
                  <th><?php echo $data2['c_math1']; ?></th>
                  <th><?php echo $data2['u_math2']; ?></th>
                  <th><?php echo $total3=$data2['u_math1']+$data2['c_math1']+$data2['u_math2']; ?> </th>
                  <th>100</th>
              </tr>
              <tr>
              <th>OSA</th>
                  <th><?php echo $data2['u_physics1']; ?></th>
                  <th><?php echo $data2['c_physics1']; ?></th>
                  <th><?php echo $data2['u_physics2']; ?></th>
                  <th><?php echo $total4=$data2['u_physics1']+$data2['c_physics1']+$data2['u_physics2']; ?></th>
                  <th>100</th>
              </tr>
              <tr>
              <th>OOP</th>
                  <th><?php echo $data2['u_chemestry1']; ?></th>
                  <th><?php echo $data2['c_chemestry1']; ?></th>
                  <th><?php echo $data2['u_chemestry']; ?></th>
                  <th><?php echo $total5=$data2['u_chemestry1']+$data2['c_chemestry1']+$data2['u_chemestry']; ?></th>
                  <th>100</th>
              </tr>
              <tr>
              <th>Total</th>
                  ...
                  <th><?php echo $data2['c_hindi1']+$data2['c_english1']+$data2['c_math1']+$data2['c_physics1']+$data2['c_chemestry1']; ?></th>
                  <th>
